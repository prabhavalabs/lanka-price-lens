...
export { computeDeals, dealRules, percentChange, shiftDay, type Deal, type DealKind, type DealsDay, type DealsOptions, type DealsRow, type EssentialWatch } from "./compute.ts";
