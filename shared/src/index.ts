 ...
 */
import { dishCategories, dishRoles, mealSlots, dishRegions, dietTags, proteinSources, dishOccasions } from "./dish-vocabulary.ts";
export { dishCategories, dishRoles, mealSlots, dishRegions, dietTags, proteinSources, dishOccasions };
