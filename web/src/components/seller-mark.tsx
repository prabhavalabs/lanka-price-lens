 ...
 * (files under `data/images/sellers/`, served by the API at `/images/sellers/`, sources listed there) on a chip in the
...
const places: Record<string, Place> = {
  ...
  keells: { color: "#1E9E4A", monogram: "K", logo: { src: "/images/sellers/keells.png", background: "#2DB84B", inset: false } },
  cargills: { color: "#D9262B", monogram: "C", logo: { src: "/images/sellers/cargills.png", background: "#E31E24", inset: false } },
  spar: { color: "#0B6E46", monogram: "S", accent: "#E1251B", logo: { src: "/images/sellers/spar.png", background: "#ffffff", inset: false } },
  glomark: { color: "#E8590C", monogram: "G", logo: { src: "/images/sellers/glomark.png", background: "#ffffff", inset: true } },
  pettah: {
    color: "#B45309",
    glyph: (
      <>
