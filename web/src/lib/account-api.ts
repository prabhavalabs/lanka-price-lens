import type { AccountLocale, AccountMenu, AccountMenuInput, AccountPreferences, AccountProfile, FavouriteEntry, ProductProposal, TelegramLinkStart, TelegramStatus, ProductProposalInput, ReactionValue, RecipeScore, RecipeSubmission, SubmissionInput, TranslationFeedback, TranslationFeedbackInput, UserRecipe, UserRecipeInput, WatchAlert, WatchEntry, WatchItem } from "@lanka-pricelens/shared";
...
export const accountApi = {
  ...
  telegram: {
    status: (signal?: AbortSignal) => call<TelegramStatus>("GET", "/v1/account/telegram", undefined, signal),
    link: () => call<TelegramLinkStart>("POST", "/v1/account/telegram/link", {}),
    unlink: () => call<null>("DELETE", "/v1/account/telegram"),
  },
  favourites: {
