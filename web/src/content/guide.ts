/**
 * The "How to use" guide: thirteen sections of steps with screenshots of the live site. The screenshots
...
export const guideSections: GuideSection[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "Card-only, promo-code, and buy-several offers are left out, and stores do not publish end dates: check the store before you travel for one.",
    ],
  },
  {
    id: "basket",
  ...
  },
  {
    ...
    figures: [
      { file: "cook", alt: "Dish cards under the basket, each with its photo, category, time, difficulty, and what it still needs", caption: "Dishes that fit what you have, best fit first, each saying what is still to buy.", width: 1704, height: 725 },
  ...
  },
  {
    ...
    steps: [
      ...
      "Thumbs up or thumbs down, on a recipe card's photo or beside “Share” on the recipe page, says whether a recipe worked for you; the number between them is likes less dislikes. The heart in the photo's other corner keeps the recipe among your favourites, listed on your account page. Reading in Sinhala or Tamil, “Is this translation right?” under the method takes Correct or Needs work with your corrected text. When a dish is missing, “Can't find a dish? Request it” under the results sends its name to the owner. All three need an account; the last two a verified address.",
    ],
    figures: [
