...
export const scenes: Scene[] = [
  { id: "board", kind: "browser", clip: "board", url: "badumila.com", from: 0.6, seconds: 5, labels: [{ at: 0, title: "Every food price, one board", subtitle: "Open markets and supermarkets side by side, refreshed daily from official bulletins and store shelves." }] },
  { id: "search", kind: "browser", clip: "search", url: "badumila.com", from: 2.2, seconds: 6.4, labels: [{ at: 0, title: "Search in any spelling", subtitle: "English, Sinhala, or Tamil. Rough spelling and shelf labels both land on the right product." }] },
  { id: "product", kind: "browser", clip: "product", url: "badumila.com/p/big-onion", from: 2.5, seconds: 7.5, labels: [
  ...
  { id: "add", kind: "browser", clip: "add", url: "badumila.com/p/big-onion", from: 1.6, seconds: 9.6, labels: [
  ...
  { id: "basket", kind: "browser", clip: "basket", url: "badumila.com/basket", from: 1.0, seconds: 10, labels: [
  ...
  { id: "dark", kind: "browser", clip: "dark", url: "badumila.com/p/big-onion", from: 2.8, seconds: 3.8, labels: [{ at: 0, title: "Light or dark", subtitle: "Follows your device, or pick one." }] },
